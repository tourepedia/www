        ...
        <Container>
          <div>
            ...
            <section>
              ...
              <p>
                <b>Includes</b>
                <br /> All inclusions are mentioned in the Blueprint given to
                you for your Trip.
              </p>
              <p>
                <b>Excludes</b>
                <br /> Anything not included in the included part. Entry
              ...
              <p>
                If the cancellation is asked for between 60 days to 30 days
                prior to the travel date 80% of the refund is initiated.
              </p>
              <p>
                If the cancellation is done between periods of 15 days to 30
                days prior to date of travel then Company provides 70% of your
                initial booking amount.
              </p>
              <p>
                If the customer calls for cancellation between 7 days to 15 days
                prior to the date of travel, he/she is entitled to 60% refund
                from the company.
              </p>
              <p>
                If the cancellation is done between a period of 72 hours from
                the time of the start of the journey to 7 days prior to the
                travel date the customer is entitled to a refund of 50% of the
                total booking amount paid.
              </p>
              <p>
                Less than 72 hours from the mentioned departure time in your
                trip – No refund.
              </p>
              <p>
                In case the customer wishes to modify his/her trip he is
                entitled to do it for free for the 1st time but it will be
                chargeable 2nd time onwards. If the modification includes
                cancellation of a part of a trip then standard cancellation
                charges apply as stated above.
              </p>
              <p>
