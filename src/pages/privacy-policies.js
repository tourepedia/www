    ...
    <StyledMain>
      <div className="container">
        <div>
          ...
          <p>
            This Privacy Policy governs the manner in which Starzone Tourepedia
            Ventures Pvt. Ltd. (henceforth referred to as "Tourepedia",
            "Company", "we", "our" or "us") collects, uses, maintains and
            discloses information collected from users (each, a "User") of the
            http://www.tourepedia.com website ("Site" or "website").
          </p>
          <section>
            ...
            <p>
              ...
              address, mailing address, phone number and social security number.
              Users may, however, visit our Site as guests. We will collect
              personal identification information from Users only if they
              voluntarily submit such information to us. Users may however
              refuse to supply personal identification information, except that
              it is required in certain Site related activities.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              When you visit to our site for our website will send cookies that
              get stored in your browser so as to enhance the availability of
              the website for future use. It prevents delay in loading the pages
              of the website due to slower internet connections. Most browsers
              accept cookies automatically but you may choose to deny the
              cookies but this may lead to malfunctioning in the site when you
              use it next time. Cookies may also be used to carry out
              transactions and disabling them may affect the functionality of
              this website.
            </p>
            <p>
            ...
            <p>
              By accessing the cookies it gives us no way by which we can access
              your personal files in your computer or your browser history.
              Cookies are only a link to you and our browsing website
            </p>
          </section>
          <section>
            <h3>How we use collected information</h3>
            <p>
              Tourepedia may collect and use Users personal information for the
              following purposes:
            </p>
            <ul>
          ...
          <section>
            ...
            <p>
              ...
              partners (hotels, tour operators, cab/taxi/bus operators etc.) to
              organize customer’s trip, or other purposes. We may use third
          ...
          <section>
            ...
            <p>
              ...
              contact us via our Site. We may use third party service providers
          ...
          <section>
            ...
            <p>
              Tourepedia has the discretion to update this privacy policy at any
              time. When we do, we will post a notification on the main page of
              our Site, revise the updated date at the bottom of this page or
          ...
          <section>
            ...
            <p>
              ...
              at{' '}
              <a href={`mailto:${AppConfig.email}`}>contact@tourepedia.com</a> .
            </p>
          </section>
          <p>This document was last updated on June 30, 2015</p>
        </div>
      </div>
    </StyledMain>
  </Layout>
